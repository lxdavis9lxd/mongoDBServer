...
app.use((req, res, next) => {
  // Allow specific GitHub codespace URL and all other origins
  const allowedOrigins = ['https://musical-bassoon-974j4j7g7jqh69-5000.app.github.dev', 'http://localhost:5000'];
